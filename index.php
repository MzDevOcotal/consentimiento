    ...
    <div class="container">
        <div class="row">
            ...
            ?>
                ...
                <p>Yo: <strong> <u> <?php echo $estudiante['nom_alu']; ?> <?php echo $estudiante['ape_alu']; ?> </u> </strong> de estado civil: <strong><u><?php echo $estado; ?></u></strong> de profesión u oficio: <?php echo $estudiante['ocupacion']; ?>, identificado con cédula número: <strong><u><?php echo $estudiante['n_cedula']; ?>,</u></strong> del domicilio de: <strong><u><?php echo $estudiante['direccion']; ?>,</u></strong> a través de la presente, declaro que he sido aceptado (a) como estudiante de la carrera de: <strong><u><?php echo $estudiante['nom_car']; ?></u></strong>, en la Universidad Martín Lutero (UML), Sede <strong><u>OCOTAL,</u></strong> en la modalidad: <strong><u><?php echo $modalidad; ?>,</u></strong>  con el objetivo de acceder a una formación plena e integral que me permita desplegar una conciencia cristiana, crítica, científica y humana; desarrollar mi personalidad y el sentido de la dignidad; y capacitarme para asumir las tareas de interés común que demanda el progreso de la nación, con lo cual podré optar al título de: <strong><u><?php echo $estudiante['tituloobt'] ? $estudiante['tituloobt'] : "___________________________"; ?></u></strong>, e insertarme al escenario laboral o emprender proyectos innovadores. </p>
